...
public class ISP {
    ...
    // Method to find nodes with only the target node as their parent
    public static List<Integer> findNodesWithOnlyTargetAsParent(int[][] edges, int target) {
        // Create a map to represent the directed graph (adjacency list)
    ...
    public static void main(String[] args) {
        // Input edges representing the graph
        int[][] edges = { { 0, 1 }, { 0, 2 }, { 1, 3 }, { 1, 6 }, { 2, 4 }, { 4, 6 }, { 4, 5 }, { 5, 7 } };
        // Target node to find nodes with only this node as their parent
        int target = 4;

        // Find nodes whose only parent is the target node
